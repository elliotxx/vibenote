...
- 日常使用、快捷键和数据管理见 [使用 Vibenote](guides/using-vibenote.zh-CN.md)。
...
- Git 自动备份的用户配置与恢复方法见 [Git 快照备份使用指南](guides/git-auto-backup.zh-CN.md)；实现边界见 [Git 自动备份设计](design/2026-08-11-git-auto-backup.md)。
- Agent CLI 的安装和命令使用见 [Agent CLI 使用指南](guides/agent-cli.zh-CN.md)。
