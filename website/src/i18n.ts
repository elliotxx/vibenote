...
export const strings: Record<Lang, Dictionary> = {
  zh: {
    ...
    "feel.kicker": "手感",
    "feel.title": "灵感 → 落笔 → 零负担",
    "feel.lead": "成功的标准很简单：灵感来了就能写，写了就在，block 边界刚好够导航。",
    "feel.step1.title": "灵感",
    "feel.step1.body": "没有欢迎向导，没有先建文件夹。灵感来时，窗口已就绪，光标已在书写位置。",
    "feel.step2.title": "落笔",
    "feel.step2.body": "想法、日志、代码片段直接落进同一条流。需要时再按 block 切开。",
    "feel.step3.title": "零负担",
    "feel.step3.body": "灵感来了就写。不用建库、不用找地方、也不用惦记保存。",
    "download.kicker": "下载",
  ...
  en: {
    ...
    "mock.status": "Written · stream.txt",
    ...
    "feel.title": "Inspiration → write → zero burden",
    "feel.lead":
      "Success is simple: when it hits you can write, what you wrote is there, block boundaries just enough to navigate.",
    "feel.step1.title": "Inspiration",
    "feel.step1.body":
      "No onboarding tour, no create-a-folder first. When it hits, the window is ready and the caret is already writing.",
    "feel.step2.title": "Write",
    "feel.step2.body":
      "Thoughts, logs, and snippets land in one stream. Split into blocks later if you need to.",
    "feel.step3.title": "Zero burden",
    "feel.step3.body":
      "When it hits, just write. No vault to set up, no place to find, nothing to remember about saving.",
